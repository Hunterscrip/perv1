...
###########- COLOR CODE -##############
colornow=$(cat /etc/Hunterscrip/theme/color.conf)
export NC="\e[0m"
export yl='\033[0;33m';
export RED="\033[0;31m"
export COLOR1="$(cat /etc/Hunterscrip/theme/$colornow | grep -w "TEXT" | cut -d: -f2|sed 's/ //g')"
export COLBG1="$(cat /etc/Hunterscrip/theme/$colornow | grep -w "BG" | cut -d: -f2|sed 's/ //g')"
WH='\033[1;37m'
###########- END COLOR CODE -##########
...
IPVPS=$(curl -s ipinfo.io/ip?token=7575 )
...
wget -q -O /etc/status "https://raw.githubusercontent.com/Hunterscrip/perv1/main/status"
...
#echo -e "$COLOR1 ${NC}         ${WH}• https/t.me/rmblvpn •${NC}             $COLOR1 $NC"
#echo -e "$COLOR1└─────────────────────────────────────────────────┘${NC}"
echo -e ""
...
11 | 11) clear ; $ressee ;;
12 | 12) clear ; $bottt ;;
88 | 88) clear ; wget -O /etc/issue.net "https://raw.githubusercontent.com/Hunterscrip/perv1/main/install/issue2.net" ;;
100) clear ; $up2u ;;
00 | 0) clear ; menu ;;
*) clear ; menu ;;
esac 
